...
- **changed**: bump to **0.7.0** (stable, aligned with the workspace; supersedes **0.6.0-rc.1**) and align path dependency `version` pins on `summer` / `summer-web` to **0.7.0**.
...
[#148]: https://github.com/summer-rs/summer-rs/pull/148

## 0.4.3

- **added**: add `Page::is_first()` & `Page::is_last()` ([#d07dc7])

[#d07dc7]: https://github.com/summer-rs/summer-rs/commit/d07dc71aaa317e3f8eb061bedce6e3094e85576f

## 0.4.2

- **added**: add `Page::is_empty()` ([#51ef1b])

[#51ef1b]: https://github.com/summer-rs/summer-rs/commit/51ef1b8878656b35577de20d558ac9c8907343a3

## 0.4.1

- **changed**: use pagination ref ([#df3adf])

[#df3adf]: https://github.com/summer-rs/summer-rs/commit/df3adf8805947d826b9a696b19e09e790efcee02
...
[#34]: https://github.com/summer-rs/summer-rs/pull/34

## 0.1.2

- **added**: Page add `iter()` ([#32])

[#32]: https://github.com/summer-rs/summer-rs/pull/31
