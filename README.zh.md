...
| `summer-xxl-job`       | [![summer-xxl-job](https://img.shields.io/crates/v/summer-xxl-job.svg)](https://github.com/summer-rs/summer-rs/tree/master/summer-xxl-job)                 | [`xxljob-sdk-rs`](https://crates.io/crates/xxljob-sdk-rs)                   | xxl-job / [ratch-job](https://github.com/ratch-job/ratch-job) 分布式任务执行器 |
...
| `summer-nacos`         | [![summer-nacos](https://img.shields.io/crates/v/summer-nacos.svg)](https://summer-rs.github.io/docs/plugins/summer-nacos/)                               | [`nacos-sdk`](https://crates.io/crates/nacos-sdk)                           | Nacos / r-nacos 配置中心与服务发现 |
