...
| `summer-xxl-job`       | [![summer-xxl-job](https://img.shields.io/crates/v/summer-xxl-job.svg)](https://summer-rs.github.io/docs/plugins/summer-xxl-job/)                           | [`xxljob-sdk-rs`](https://crates.io/crates/xxljob-sdk-rs)                   | xxl-job / [ratch-job](https://github.com/ratch-job/ratch-job) 分布式任务执行器 |
