...
| `summer-xxl-job`        | [![summer-xxl-job](https://img.shields.io/crates/v/summer-xxl-job.svg)](https://github.com/summer-rs/summer-rs/tree/master/summer-xxl-job)                 | [`xxljob-sdk-rs`](https://crates.io/crates/xxljob-sdk-rs)                   | Distributed job executor for xxl-job / [ratch-job](https://github.com/ratch-job/ratch-job) |
