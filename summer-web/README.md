...
summer-web provides runtime validation wrappers for two validation frameworks. Validation failures are automatically converted to [RFC 9457](https://www.rfc-editor.org/rfc/rfc9457) compliant `ProblemDetails` responses with field-level error information.
