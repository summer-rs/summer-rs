//! Validator integration for RFC 9457 ProblemDetails.
...
/// Validator wrapper for extractors implementing `Validate`.
...
/// Validator wrapper for extractors implementing `ValidateArgs`.
#[derive(Debug, Clone, Copy, Default)]
